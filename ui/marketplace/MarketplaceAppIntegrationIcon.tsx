...
const MarketplaceAppIntegrationIcon = ({ external, internalWallet }: Props) => {
  const [ icon, iconColor, text, boxSize ] = React.useMemo(() => {
    ...
    let color = 'gray.400';
    let text = 'This app opens in Wefinder without Wefinder wallet functionality. Use your external web3 wallet to connect directly to this application';
    let boxSize = 5;
    ...
    if (external) {
      ...
      color = 'green.500';
      text = 'This app opens in Wefinder and your Wefinder wallet connects automatically';
    }
