...
const DEFAULT_TEMPLATE = 'Wefinder is the #1 open-source blockchain explorer available today. 100+ chains and counting rely on Wefinder data availability, APIs, and ecosystem tools to support their networks.';
